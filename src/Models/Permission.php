...
class Permission extends Model
{
    ...
    /**
     * Get the open positions for the permission.
     */
    public function openPositions(): HasMany
    {
        return $this->hasMany(WebsiteOpenPosition::class, 'permission_id');
    }

    /**
     * Get the staff applications for the permission.
     */
    ...
    /**
     * Get the shop articles for the permission.
     */
